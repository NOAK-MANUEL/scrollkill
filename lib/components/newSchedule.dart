...
class NewSchedule extends StatefulWidget {
  const NewSchedule({super.key, this.onSave, this.onEdit, this.editContent});

  final Future<void> Function(UserSchedule schedule)? onSave;
  final Future<void> Function(UserSchedule schedule)? onEdit;
  final UserSchedule? editContent;
...
class _NewScheduleState extends State<NewSchedule> {
  ...
  final List<PeriodListType> days = const [
    ...
    PeriodListType(index: 4, type: "Th"),
  ...
  void _edit(UserSchedule content) async {
